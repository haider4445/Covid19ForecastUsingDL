...
class COVID_GRU(nn.Module):
    def __init__(self,n_hidden,n_features):
        super().__init__()
        # LSTM takes input as (batch, seq_len=30, input_size=1):
        self.gru1 = nn.GRU(input_size =n_features, hidden_size =n_hidden,batch_first =True)
        self.gru2 = nn.GRU(input_size =n_hidden, hidden_size =n_hidden,batch_first =True)
        self.gru3 = nn.GRU(input_size =n_hidden, hidden_size =n_hidden,batch_first =True)
